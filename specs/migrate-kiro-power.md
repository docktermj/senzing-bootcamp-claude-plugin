...
The template of a successful Senzing Bootcamp is currently a Kiro Power located in
~/github.com/docktermj/senzing-bootcamp-kiro-powers/senzing-bootcamp

From that template, create a Senzing Bootcamp Claude Plugin in ~/github.com/docktermj/senzing-bootcamp-claude-plugin

Use Claude Agents, Hooks, or any other Claude Plugin technique to deliver an equivalent or better Bootcamp experience.
Reference: <https://code.claude.com/docs/en/plugins-reference>

Review, test, and modify the Senzing Bootcamp Claude Plugin over-and-over as needed to create an easy-to-use Senzing Bootcamp
that creates code and documentation that can be used by the Bootcamper.

When the Bootcamper runs the Senzing Bootcamp Claude Plugin, these should be the outcomes:
...
- Outcomes of the entire Bootcamp:
  ...
  - All questions must be answered by the Bootcamper.  Kiro cannot answer questions nor assume answers.
  ...
  - All modules performed in order.  i.e Module 1 -> Module 2 -> Module 3 -> Module 4 -> Module 5 -> Module 6 -> Module 7
...
- Outcomes of Module 3:
  - The Bootcamper sees a visualization of the Truth Set to verify that Senzing works on the Bootcampers workstation.
...
- Using appropriate Claude Plugin techniques, implement the features captured in the Kiro Power hook files and steering files.
